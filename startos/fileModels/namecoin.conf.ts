...
const validNets = ['ipv4', 'ipv6', 'onion'] as const
...
export const fullConfigSpec = sdk.InputSpec.of({
  ...
  zmqEnabled: Value.triState({
    ...
    description: i18n(
      'The ZeroMQ interface is useful for some applications which might require data related to block and transaction events from Namecoin Core. For example, LND requires ZeroMQ be enabled for LND to get the latest block data',
    ),
    default: true,
  ...
  wallet: Value.object(
    ...
    InputSpec.of({
      ...
      discardfee: Value.number({
        ...
        description: i18n(
          'The fee rate (in NMC/kB) that indicates your tolerance for discarding change by adding it to the fee.',
        ),
        required: false,
        default: null,
        min: 0,
        ...
        integer: false,
        units: i18n('NMC/kB'),
        footnote: `${i18n('Default')}: 0.0001 NMC/kB`,
      }),
    }),
  ),
            ...
            List.text(
              {
                ...
                minLength: 1,
                description: i18n(
                  'Add addresses of nodes for Namecoin to EXCLUSIVELY connect to.',
                ),
              },
              {
                patterns: [
            ...
            List.text(
              {
                name: i18n('Add Nodes'),
                description: i18n(
                  'Add addresses of nodes for Namecoin to connect with in addition to default nodes.',
                ),
              },
              {
                inputmode: 'text',
...
export const namecoinConfFile = FileHelper.ini(
  {
    base: sdk.volumes.main,
    subpath: '/namecoin.conf',
  },
